...
* <b>Admin2</b>: Country name. US only.
...
* September 14, Daily product generation occurred before Indian Ministry of Health and Family Welfare provided daily update. Time series files (but not daily reports) updated to correct this error with the numbers that should have been reported.
