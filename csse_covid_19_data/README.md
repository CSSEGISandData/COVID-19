...
* June 5, Russia and Ukraine. We have recently implemented subnational data for the Russian Federation. In preparing for this adjustment, it has become clear that the Russian Federation allocates cases in Crimea and Sevastopol to their national totals while the nation of Ukraine does not include these regions in their data. To stay consistent with the diplomatic relations set out by the United States State Department, we have chosen to distribute the cases within Crimea and Sevastopol to the nation of Ukraine. This adjustment explains our difference in national cases for both the Russian Federation and Ukraine with national reporting and other data aggregation efforts.
* June 5, Sweden. In an internal audit of the data for Sweden, it has become clear to our team that our reported total of recoveries is unverifiable and likely inaccurate. Our historical data did not come from national reporting and was likely conflated with reports of patients being released from hospitals in some regions within the country. To ensure the accuracy of our data, we have chosen to nullify the number of recovered cases in Sweden until the data is released by the national health ministry. We will also be removing data from our historical time series due to a lack of confidence in what was previously reported.
