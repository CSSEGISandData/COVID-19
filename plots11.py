...
# @Last Modified time: 2020-04-04 18:33:44
...
def plot_by_regions(df_confirmed, df_deaths, time_datetime, **kwarg):
    ...
    ax.legend(wedges, labels, loc="center right", bbox_to_anchor = (1.1, 0, 0, 1))
    ax.axis('equal')
    ...
    ax.legend(plot_list + 
               [f'20% daily incrase',
                f'40% daily increase'],
               loc="center right",
               bbox_to_anchor = (1.01, 0, 0.2, 1)) #bbox_to_anchor = (1, 0, 0.35, 1)
    ax.set_yscale('log')
